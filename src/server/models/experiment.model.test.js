...
describe("Experiment", () => {
  ...
  describe("#toJSON", () => {
    describe("when valid", () => {
      describe("when transforming core details", () => {
        it("should transform core details", async done => {
          const experiment = await Experiment.get(args.id);
        ...
        it("should transform the owner", async done => {
          const experiment = await Experiment.get(args.id);
        ...
        it("should transform metadata", async done => {
          const experiment = await Experiment.get(args.id);
          const json = experiment.toJSON();
      ...
      describe("when transforming results", () => {
        describe("when transforming distance results", () => {
        ...
        describe("when transforming predictor results", () => {
          it("should transform experiment results", async done => {
            const experimentDataWithResults = new Experiment(
  ...
  describe("#findByIsolateIds", () => {
    ...
    describe("when invalid", () => {
      describe("when there are no matching experiments", () => {
        it("should return an empty array", async done => {
          const savedMetadata = args.savedExperiment.get("metadata");
          const isolateIds = ["unknown-isolate-id"];
