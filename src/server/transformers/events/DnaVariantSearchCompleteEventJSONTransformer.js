 ...
 */
class DnaVariantSearchCompleteEventJSONTransformer extends SearchEventJSONTransformer {
  /**
  ...
  transform(o, options) {
    ...
    res.event = Constants.EVENTS.DNA_VARIANT_SEARCH_COMPLETE.NAME;

    return res;
  }
}

export default DnaVariantSearchCompleteEventJSONTransformer;
